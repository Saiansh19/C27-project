...
function setup() {
	...
	bobObject1 = new bob (200, 10, 30);
	bobObject2 = new bob (210, 10, 30);
	bobObject3 = new bob (220, 10, 30);
	bobObject4 = new bob (230, 10, 30);
	bobObject5 = new bob (240, 10, 30);
